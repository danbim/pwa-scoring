...
var _danbim$pwa_scoring$Model$WaveScore = function (a) {
	return {points: a};
};
var _danbim$pwa_scoring$Model$JumpScore = F2(
	function (a, b) {
		return {jumpType: a, points: b};
	});
var _danbim$pwa_scoring$Model$ScoreSheet = F2(
	function (a, b) {
		return {waveScores: a, jumpScores: b};
	});
var _danbim$pwa_scoring$Model$HeatLiveStreamRiderState = F2(
	function (a, b) {
		return {totalScore: a, scoreSheet: b};
	});
var _danbim$pwa_scoring$Model$HeatLiveStreamState = F5(
	function (a, b, c, d, e) {
		return {heatId: a, started: b, ended: c, riderStates: d, leader: e};
	});
var _danbim$pwa_scoring$Model$UnknownJumpType = {ctor: 'UnknownJumpType'};
var _danbim$pwa_scoring$Model$TableTop = {ctor: 'TableTop'};
var _danbim$pwa_scoring$Model$FrontLoop = {ctor: 'FrontLoop'};
var _danbim$pwa_scoring$Model$BackLoop = {ctor: 'BackLoop'};
...
var _danbim$pwa_scoring$Decoder$stringToJumpType = function (str) {
	var _p0 = _elm_lang$core$String$toLower(str);
	switch (_p0) {
		case 'backloop':
			return _danbim$pwa_scoring$Model$BackLoop;
		case 'frontloop':
			return _danbim$pwa_scoring$Model$FrontLoop;
		case 'tabletop':
			return _danbim$pwa_scoring$Model$TableTop;
		default:
			return _danbim$pwa_scoring$Model$UnknownJumpType;
	}
};
var _danbim$pwa_scoring$Decoder$jumpTypeDecoder = A2(_elm_lang$core$Json_Decode$map, _danbim$pwa_scoring$Decoder$stringToJumpType, _elm_lang$core$Json_Decode$string);
var _danbim$pwa_scoring$Decoder$pointsDecoder = _elm_lang$core$Json_Decode$float;
var _danbim$pwa_scoring$Decoder$jumpScoreDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_danbim$pwa_scoring$Model$JumpScore,
	A2(_elm_lang$core$Json_Decode$field, 'jumpType', _danbim$pwa_scoring$Decoder$jumpTypeDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'points', _danbim$pwa_scoring$Decoder$pointsDecoder));
var _danbim$pwa_scoring$Decoder$waveScoreDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_danbim$pwa_scoring$Model$WaveScore,
	A2(_elm_lang$core$Json_Decode$field, 'points', _danbim$pwa_scoring$Decoder$pointsDecoder));
var _danbim$pwa_scoring$Decoder$scoreSheetDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_danbim$pwa_scoring$Model$ScoreSheet,
	A2(
		_elm_lang$core$Json_Decode$field,
		'waveScores',
		_elm_lang$core$Json_Decode$list(_danbim$pwa_scoring$Decoder$waveScoreDecoder)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'jumpScores',
		_elm_lang$core$Json_Decode$list(_danbim$pwa_scoring$Decoder$jumpScoreDecoder)));
var _danbim$pwa_scoring$Decoder$heatLiveStreamRiderStateDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_danbim$pwa_scoring$Model$HeatLiveStreamRiderState,
	A2(_elm_lang$core$Json_Decode$field, 'totalScore', _danbim$pwa_scoring$Decoder$pointsDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'scoreSheet', _danbim$pwa_scoring$Decoder$scoreSheetDecoder));
var _danbim$pwa_scoring$Decoder$heatLiveStreamRiderStatesDecoder = _elm_lang$core$Json_Decode$dict(_danbim$pwa_scoring$Decoder$heatLiveStreamRiderStateDecoder);
var _danbim$pwa_scoring$Decoder$heatLiveStreamStateDecoder = A6(
	_elm_lang$core$Json_Decode$map5,
	_danbim$pwa_scoring$Model$HeatLiveStreamState,
	A2(_elm_lang$core$Json_Decode$field, 'heatId', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'started', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'ended', _elm_lang$core$Json_Decode$bool),
	A2(
		_elm_lang$core$Json_Decode$field,
		'riderStates',
		_elm_lang$core$Json_Decode$maybe(_danbim$pwa_scoring$Decoder$heatLiveStreamRiderStatesDecoder)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'leader',
		_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$string)));
var _danbim$pwa_scoring$Decoder$decodeHeatLiveStreamStateFromJson = _elm_lang$core$Json_Decode$decodeString(_danbim$pwa_scoring$Decoder$heatLiveStreamStateDecoder);
var _danbim$pwa_scoring$Decoder$riderIdDecoder = _elm_lang$core$Json_Decode$string;
var _danbim$pwa_scoring$Decoder$heatIdDecoder = _elm_lang$core$Json_Decode$string;
...
var _danbim$pwa_scoring$Viewer$update = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _danbim$pwa_scoring$Viewer$emptyRiderStates = {
	ctor: '::',
	_0: A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$row,
		{ctor: '[]'},
...
var _danbim$pwa_scoring$Viewer$viewRiderState = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$html$Html$text(
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				' => ',
				_elm_lang$core$Basics$toString(_p1._1.totalScore))));
};
var _danbim$pwa_scoring$Viewer$viewRiderStates = function (riderStates) {
	var toRow = function (_p2) {
		var _p3 = _p2;
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Grid$row,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _danbim$pwa_scoring$Viewer$viewRiderState(
	...
	return A2(
		_elm_lang$core$List$map,
		toRow,
		_elm_lang$core$Dict$toList(riderStates));
};
var _danbim$pwa_scoring$Viewer$viewState = function (state) {
	var riderStatesRows = A2(
		_elm_lang$core$Maybe$withDefault,
		_danbim$pwa_scoring$Viewer$emptyRiderStates,
		A2(_elm_lang$core$Maybe$map, _danbim$pwa_scoring$Viewer$viewRiderStates, state.riderStates));
	var heatIdRow = A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$row,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(state.heatId),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Jumps'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Waves'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Posn.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
	...
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$List$append, headers, riderStatesRows));
};
var _danbim$pwa_scoring$Viewer$view = function (model) {
	var _p4 = model;
	if (_p4.ctor === 'Ok') {
		return _danbim$pwa_scoring$Viewer$viewState(_p4._0);
	} else {
		return _elm_lang$html$Html$text(_p4._0);
	}
};
var _danbim$pwa_scoring$Viewer$viewScoreSheet = function (scoreSheet) {
	var jumpScoreToHtml = function (js) {
		return _elm_lang$html$Html$text(
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(js.points),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'(',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(js.jumpType),
						')'))));
	};
	var jumpScoresHtml = A2(_elm_lang$core$List$map, jumpScoreToHtml, scoreSheet.jumpScores);
	var waveScoreToHtml = function (ws) {
		return _elm_lang$html$Html$text(
			_elm_lang$core$Basics$toString(ws.points));
	};
	var waveScoresHtml = A2(_elm_lang$core$List$map, waveScoreToHtml, scoreSheet.waveScores);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$Basics_ops['++'], waveScoresHtml, jumpScoresHtml));
};
var _danbim$pwa_scoring$Viewer$json = '\n{\n  \"ended\": false,\n  \"leader\": \"GER-123\",\n  \"riderStates\": {\n    \"GER-123\": {\n      \"totalScore\": 20.9,\n      \"scoreSheet\": {\n        \"waveScores\": [\n          {\n            \"points\": 9.9\n          }\n        ],\n        \"jumpScores\": [\n          {\n            \"jumpType\": \"backloop\",\n            \"points\": 7.6\n          },\n          {\n            \"jumpType\": \"tabletop\",\n            \"points\": 3.4\n          }\n        ]\n      }\n    },\n    \"GER-321\": {\n      \"totalScore\": 14.1,\n      \"scoreSheet\": {\n        \"waveScores\": [\n          {\n            \"points\": 8.7\n          }\n        ],\n        \"jumpScores\": [\n          {\n            \"jumpType\": \"backloop\",\n            \"points\": 5.4\n          }\n        ]\n      }\n    }\n  },\n  \"heatId\": \"1-A\",\n  \"started\": true\n}\n';
var _danbim$pwa_scoring$Viewer$init = function () {
	var _p5 = _danbim$pwa_scoring$Decoder$decodeHeatLiveStreamStateFromJson(_danbim$pwa_scoring$Viewer$json);
	if (_p5.ctor === 'Ok') {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Result$Ok(_p5._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	} else {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Result$Err(_p5._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	}
}();
var _danbim$pwa_scoring$Viewer$main = _elm_lang$html$Html$program(
	{
		init: _danbim$pwa_scoring$Viewer$init,
		view: _danbim$pwa_scoring$Viewer$view,
		update: _danbim$pwa_scoring$Viewer$update,
		subscriptions: function (_p6) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
var _danbim$pwa_scoring$Viewer$None = {ctor: 'None'};

var Elm = {};
Elm['Viewer'] = Elm['Viewer'] || {};
if (typeof _danbim$pwa_scoring$Viewer$main !== 'undefined') {
    _danbim$pwa_scoring$Viewer$main(Elm['Viewer'], 'Viewer', undefined);
}
