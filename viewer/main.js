...
var _danbim$pwa_scoring$Main$view = function (model) {
	return A2(
...
var _danbim$pwa_scoring$Main$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_danbim$pwa_scoring$Main$view('dummy model'));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _danbim$pwa_scoring$Main$main !== 'undefined') {
    _danbim$pwa_scoring$Main$main(Elm['Main'], 'Main', undefined);
}
